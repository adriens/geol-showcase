...
\hline
\rowcolor{lightgray}
\textbf{If Your Version Is...} & \textbf{Action Required} \\ \hline
\rowcolor{lightred} ≤ 13 (EOL) & \textbf{URGENT}: Migrate immediately (2-10× more vulnerabilities) \\ \hline
\rowcolor{lightorange} 14 & Plan upgrade to 16/17 (EOL approaching 2026) \\ \hline
\rowcolor{lightgreen} 15-17 & Monitor for patches, review annually \\ \hline
\rowcolor{lightgreen} 18 (Latest) & Excellent - maintain patch currency \\ \hline
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item \textbf{Patch Effectiveness}: v18.1 fixed \textbf{22\%} of vulnerabilities compared to v18.0
...
\textbf{Unsupported versions (9.6-13) contain 2-10× more vulnerabilities than supported versions (14-18).} PostgreSQL 12 alone has \textbf{305 total vulnerabilities} including \textbf{9 critical CVEs}, compared to just \textbf{113 total} and \textbf{0 critical} in version 17.
\end{tcolorbox}
...
\rowcolor{lightgreen} \textbf{Risk Reduction} & - & \textbf{63\%} \\
...
Upgrading from PostgreSQL 12 to 17 eliminates \textbf{all 9 critical vulnerabilities}, reduces high-severity issues by \textbf{91\%}, and provides \textbf{5 years of continued support}. The security ROI is immediate and substantial.
\end{tcolorbox}
