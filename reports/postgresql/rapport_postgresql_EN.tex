...
\begin{tcolorbox}[colback=lightgray!20, colframe=black!50, title=Risk Level Determination Logic, fonttitle=\bfseries]
\begin{enumerate}
    \item \textcolor{vuln-critical}{\textbf{High Risk:}} Score $>$ 300 \textbf{OR} $n_{\text{Critical}} \geq 3$
    \item \textcolor{vuln-medium}{\textbf{Medium Risk:}} Score $\in$ [150, 300] \textbf{OR} $n_{\text{Critical}} \geq 1$
    \item \textcolor{gantt-supported}{\textbf{Low Risk:}} Score $<$ 150 \textbf{AND} $n_{\text{Critical}} = 0$
\end{enumerate}
\end{tcolorbox}
