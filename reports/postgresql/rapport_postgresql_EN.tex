...
\node at (axis cs:Critical,13) [black] {\tiny\bf 0};
\node at (axis cs:Low,13) [white] {\tiny\bf 98};
\node at (axis cs:Critical,14) [black] {\tiny\bf 0};
\node at (axis cs:Low,14) [white] {\tiny\bf 98};
\node at (axis cs:Critical,15) [black] {\tiny\bf 0};
\node at (axis cs:Low,15) [white] {\tiny\bf 98};
\node at (axis cs:Critical,16) [black] {\tiny\bf 0};
\node at (axis cs:Low,16) [white] {\tiny\bf 98};
\node at (axis cs:Critical,17) [black] {\tiny\bf 0};
